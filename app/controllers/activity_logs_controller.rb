  ...
  def create
    ...
    respond_to do |format|
      if @activity_log.save
        format.html { redirect_to(@activity_log, :notice => 'ActivityLog was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @activity_log.update_attributes(params[:activity_log])
        format.html { redirect_to(@activity_log, :notice => 'ActivityLog was successfully updated.') }
        format.xml  { head :ok }
      else
